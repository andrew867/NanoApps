...
static const en_preset_t s_presets[] = {
    { "Delta 2 Hz",   "2 Hz binaural beat, 100 Hz carrier",
      2.0,  100.0, EN_MODE_BINAURAL, EN_NOISE_NONE, 0.0 },
    { "Theta 6 Hz",   "6 Hz binaural beat, 150 Hz carrier",
      6.0,  150.0, EN_MODE_BINAURAL, EN_NOISE_NONE, 0.0 },
    { "Schumann",     "7.83 Hz binaural beat, 200 Hz carrier",
      7.83, 200.0, EN_MODE_BINAURAL, EN_NOISE_NONE, 0.0 },
    { "Alpha 10 Hz",  "10 Hz binaural beat, 200 Hz carrier",
      10.0, 200.0, EN_MODE_BINAURAL, EN_NOISE_NONE, 0.0 },
    { "Beta 16 Hz",   "16 Hz binaural beat, 250 Hz carrier",
      16.0, 250.0, EN_MODE_BINAURAL, EN_NOISE_NONE, 0.0 },
    { "Gamma 40 Hz",  "40 Hz binaural beat, 300 Hz carrier",
      40.0, 300.0, EN_MODE_BINAURAL, EN_NOISE_NONE, 0.0 },
    { "Alpha + Pink", "10 Hz binaural beat, 200 Hz carrier, pink noise bed",
      10.0, 200.0, EN_MODE_BINAURAL, EN_NOISE_PINK, 0.18 },
    { "Theta Speaker","6 Hz isochronic gate, 150 Hz carrier",
      6.0,  150.0, EN_MODE_ISOCHRONIC, EN_NOISE_NONE, 0.0 },
    { "Delta Brown",  "2 Hz binaural beat, 100 Hz carrier, brown noise bed",
...
static const en_program_t s_programs[] = {
    { "Wind Down",
      "10 Hz to 6 Hz to 2 Hz over 45 min, 200 Hz carrier",
      EN_MODE_BINAURAL, PROG(s_wind_down) },
    { "Power Nap",
      "8 Hz to 3 Hz, then a 2 min ramp to 12 Hz. 20 min",
      EN_MODE_BINAURAL, PROG(s_power_nap) },
    { "Deep Focus",
      "14-18-14 Hz over 60 min, 250 Hz carrier, pink noise bed",
      EN_MODE_BINAURAL, PROG(s_deep_focus) },
    { "Creative Drift",
      "Steady 7.5 Hz, 180 Hz carrier, 30 min",
      EN_MODE_BINAURAL, PROG(s_creative_drift) },
    { "Morning Lift",
      "6 Hz to 18 Hz over 15 min, carrier 200 to 260 Hz",
      EN_MODE_BINAURAL, PROG(s_morning_lift) },
    { "Meditation Descent",
      "11 Hz to 5.5 Hz over 30 min, long fades",
